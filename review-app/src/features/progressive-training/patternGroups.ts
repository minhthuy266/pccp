...
export const progressivePatternGroups: ProgressivePatternGroup[] = [
  ...
  },
  {
    id: "tree-traversal",
    order: 6,
    title: "Tree và component traversal",
    pattern: "Build adjacency → mark visited → expand reachable state",
    recognition: "Input là cạnh hai chiều/tree; cần đếm, chia component hoặc đi từ root mà không quay lại parent.",
    invariant: "Visited chứa đúng node reachable theo graph hiện tại; mỗi node được đưa vào frontier tối đa một lần.",
    prerequisite: "Sau grid neighborhood và decision-tree recursion",
    lessonIds: ["PT-OF023-POWER-GRID"],
  },
  {
    id: "interval-greedy",
    order: 7,
